...
public class StoryPlayerContentItem extends PlayerContentItem {
  ...
  public StoryPlayerContentItem(int id, Date timestamp, String authorsString, int authorsCount, 
      String storySpecificDescription, Importance importance, 
      PlayerContentItem parentPlayerContentItem) {
    super(id, timestamp, authorsString, authorsCount, storySpecificDescription, importance, 
