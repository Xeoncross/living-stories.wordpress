...
public class Filmstrip extends Composite {
  private static final String ENABLED_PREVIOUS_ARROW =
      Externs.getTemplateDirectory() + "/images/arrow-left.gif";
  private static final String DISABLED_PREVIOUS_ARROW =
      Externs.getTemplateDirectory() + "/images/arrow-left-disabled.gif";
  private static final String ENABLED_NEXT_ARROW = 
      Externs.getTemplateDirectory() + "/images/arrow-right.gif";
  private static final String DISABLED_NEXT_ARROW = 
      Externs.getTemplateDirectory() + "/images/arrow-right-disabled.gif";
