...
//  private final ContentRpcServiceAsync contentService = GWT.create(ContentRpcService.class);
   ...
   */
  public SourceInfoWidget(int sourceContentItemId, BaseContentItem sourceContentItem,
  ...
  private class SourceLinkClickHandler implements ClickHandler {
    ...
    private int sourceContentItemId;
    private BaseContentItem sourceContentItem;
    
    public SourceLinkClickHandler(int sourceContentItemId, BaseContentItem sourceContentItem, 
        String sourceDescription) {
    ...
    public void onClick(ClickEvent e) {
      if (sourceContentItem == null && sourceContentItemId > 0) {
        // TODO: Implement this when the post loader can handle async
        // loading of individual posts.
//        request.do(new PostLoaderRequest(sourceContentItemId) {  
