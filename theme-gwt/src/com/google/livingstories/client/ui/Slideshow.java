...
public class Slideshow {
  ...
  public Slideshow(List<AssetContentItem> images) {
    ...
    // Ensure this is in front of the popup panel's glass.
    DOM.setStyleAttribute(filmstripPopup.getElement(), "zIndex", "1");
  ...
  private void displayImage(int index) {
    ...
    // Reposition the popup/filmstrip to take image size changes, window size changes,
    // and scrolling into account.
    // Show the filmstrip first; the popup's glass will then cover it.
    // TODO: fix this and get the glass to cover neither.
    showFilmstrip();
    showPopup();
  }
