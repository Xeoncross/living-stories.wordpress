...
public class TimelineWidget<T> extends Composite {
  ...
  public TimelineWidget(Integer widthInPixels, Integer heightInPixels,
    ...
    leftArrow = new Image(Externs.getTemplateDirectory() + "/images/inverse-arrowhead-left.gif");
    leftArrow.setStylePrimaryName("disabledArrowHead");

    rightArrow = new Image(Externs.getTemplateDirectory() + "/images/inverse-arrowhead-right.gif");
