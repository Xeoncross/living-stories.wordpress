...
public class AssetContentItem extends BaseContentItem {
  ...
  public AssetContentItem(int id, Date timestamp, String authorsString, int authorsCount,
      String content, Importance importance, AssetType assetType, String caption,
      String previewUrl) {
    super(id, timestamp, ContentItemType.ASSET, authorsString, authorsCount, content, importance);
