...
public class NarrativeLinkClickedEvent extends GwtEvent<NarrativeLinkClickedEvent.Handler> {
  ...
  private int containerContentItemId;
  private int narrativeContentItemId;
  
  public NarrativeLinkClickedEvent(int containerContentItemId, int narrativeContentItemId) {
    this.containerContentItemId = containerContentItemId;
    this.narrativeContentItemId = narrativeContentItemId;
  }
  
  public int getContainerContentItemId() {
    return containerContentItemId;
  }
  
  public int getNarrativeContentItemId() {
