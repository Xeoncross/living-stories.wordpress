...
public class PlayerContentItem extends BaseContentItem {
  ...
  public PlayerContentItem(int id, Date timestamp, String authorsString, int authorsCount,
      String content, Importance importance, String name, List<String> aliases,
      PlayerType playerType, AssetContentItem photoContentItem) {
    super(id, timestamp, ContentItemType.PLAYER, authorsString, authorsCount, content, importance);
    this.name = name;
  ...
  public int getPhotoContentItemId() {
