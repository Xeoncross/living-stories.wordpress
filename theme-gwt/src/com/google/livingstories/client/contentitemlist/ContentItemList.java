...
public class ContentItemList extends Composite {
  ...
  private Set<Integer> contentItemIdsInPanel;
  private Map<Integer, BaseContentItem> idToContentItemMap;
  ...
  private ContentItemList(ContentItemClickHandler handler) {
    ...
    contentItemIdsInPanel = new HashSet<Integer>();
   ...
   */
  public void load(
      List<BaseContentItem> contentItems, Map<Integer, BaseContentItem> idToContentItemMap) {
    clear();    
   ...
   * found
   */
  public boolean openElements(Set<Integer> contentItemIds) {
    ...
    if (singleRowToScrollTo != null) {
      WindowScroll.scrollTo(singleRowToScrollTo.getAbsoluteTop(), null);
    }
