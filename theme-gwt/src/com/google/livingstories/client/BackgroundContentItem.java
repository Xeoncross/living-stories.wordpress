...
public class BackgroundContentItem extends BaseContentItem {
  ...
  public BackgroundContentItem(int id, Date timestamp, String authorsString, int authorsCount,
      String content, Importance importance, String conceptName) {
    super(id, timestamp, ContentItemType.BACKGROUND, authorsString, authorsCount, content,
        importance);
