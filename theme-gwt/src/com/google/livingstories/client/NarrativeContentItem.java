...
public class NarrativeContentItem extends BaseContentItem {
  ...
  public NarrativeContentItem(int id, Date timestamp, String authorsString, int authorsCount,
      String content, Importance importance, String headline, NarrativeType narrativeType,
      boolean isStandalone, Date narrativeDate, String narrativeSummary) {
    super(id, timestamp, ContentItemType.NARRATIVE, authorsString, authorsCount, content,
        importance);
